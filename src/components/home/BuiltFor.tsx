...
const BuiltFor = (): JSX.Element => {
  return (
    <div className="flex justify-center">
      <div className="max-w-[1440px] z-30 md:mt-40 xl:mt-64 relative flex flex-col min-h-fit items-start xl:items-start lg:justify-center lg:items-start gap-10 md:gap-40 xl:gap-56 md:flex-row w-full p-5 md:px-20 lg:px-32 lg:py-16 xl:pb-32 overflow-hidden">
