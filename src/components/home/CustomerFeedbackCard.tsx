...
const CustomerFeedbackCard: React.FC<CustomerFeedbackCardProps> = ({
  ...
  return (
    <div
      className={`customer-feedback-card md:w-[33%] flex flex-col items-center justify-between bg-tailCall-dark-600 tailcall-light-100 text-tailCall-white py-SPACE_06 px-SPACE_06 text-center text-content-small gap-y-SPACE_06 pb-10 ${classNames} ${
