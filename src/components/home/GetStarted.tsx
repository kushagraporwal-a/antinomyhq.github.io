...
const GetStarted = (): JSX.Element => {
 ...
 -tracking-normal"
        ...
        <span
          className="absolute top-28 left-0 sm:left-40 md:top-40 xl:top-64 xl:left-[450px] font-bebas text-[48px] md:text-[96px] xl:text-[132px] font-normal text-transparent bg-clip-text bg-[radial-gradient(3039.26%_162.31%_at_88.96%_175.81%,_#FFF_0%,_#747474_100%)]
 -tracking-normal"
        >
          ON YOUR TERMINAL
        </span>
      ...
      <div className="flex flex-col gap-5 absolute top-60 md:top-80 xl:top-auto xl:bottom-32 xl:left-[550px] w-full xl:max-w-[600px] pr-8">
        <div className="bg-[#1E1C21] flex flex-col rounded-2xl relative">
          ...
          <div className="pt-8 px-8 pb-4">
            <span className="text-[#30EDE6] font-space text-content-tiny md:text-title-medium font-normal -tracking-wide">
