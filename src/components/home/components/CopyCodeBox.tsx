...
const cls = {
  ...
  outerBox:
    "w-full max-w-[700px] bg-tailCall-lightMode---neutral-200 dark:bg-gradient-315 rounded-xl p-[1px] cursor-pointer",
  innerBox: "bg-white dark:bg-[#1E1C21] flex__column rounded-xl relative",
