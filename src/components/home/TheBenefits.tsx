...
const TheBenefits = (): JSX.Element => {
  ...
  return (
    <div className="flex justify-center">
      <div
        ref={sectionRef}
        className="xl:max-w-[1280px] relative w-full h-screen mt-[500px] flex flex-col pt-10 z-10 xl:pt-20 overflow-hidden"
      >
        <div
        ...
        >
          ...
          <span
            className="absolute top-0 left-8 xl:left-28 font-bebas text-display-medium md:text-display-large xl:text-[142px] font-normal md:font-normal text-transparent bg-clip-text bg-[radial-gradient(3039.26%_162.31%_at_88.96%_175.81%,_#FFF_0%,_#484848_100%)]
 -tracking-normal"
          >
            THE
          </span>
 ...
 -tracking-normal"
          ...
          <div
            className="absolute left-10 md:left-20 lg:left-60 xl:left-auto right-10 lg:right-40 top-[500px] flex flex-col items-center"
