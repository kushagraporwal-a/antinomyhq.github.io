...
const Footer = (): JSX.Element => {
  ...
  return (
    <footer className="flex flex-col relative w-full px-4 py-8 lg:px-40 lg:pt-20 lg:pb-0 bg-tailCall-dark-700 dark:bg-tailCall-darkMode---neutral-900 grid-dark gap-4 lg:gap-8">
