...
const Footer = (): JSX.Element => {
  ...
  return (
    <footer className="flex flex-col relative w-full relative px-4 py-8 lg:px-40 lg:pt-20 lg:pb-0 dark:bg-tailCall-dark-700 bg-tailCall-light-900 grid-dark gap-4 lg:gap-8">
