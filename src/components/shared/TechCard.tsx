  ...
  return (
    <div
      className={
        ...
        `hover:rotate-0 hover:bg-[radial-gradient(41.85%_42.23%_at_53.3%_102.3%,rgba(48,237,230,0.8)_0%,#1C1D1F_100%)] hover:dark:bg-[radial-gradient(37.73%_37.61%_at_50.74%_103.75%,rgba(48,237,230,0.8)_0%,#18171A_100%)]`
      }
    >
      <div className={
