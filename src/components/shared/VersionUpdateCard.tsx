...
const VersionUpdateCard = () => {
  return (
    <div className="flex flex-col sm:flex-row py-8 px-6 sm:px-11 bg-white dark:bg-tailCall-dark-600 justify-between items-start sm:items-center gap-4 version-update-card">
