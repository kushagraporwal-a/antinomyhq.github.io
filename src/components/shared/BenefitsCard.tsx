...
const BenefitsCard = ({title, description, imageUrl}: BenefitsCardProps) => {
  return (
    <div className="bg-[linear-gradient(to_bottom_right,_#000000,_#1B8783B2)] p-[2px] rounded-3xl w-full md:w-96 xl:w-[550px]">
      <div className="flex flex-col gap-4 bg-[linear-gradient(180deg,_#1E1C21_0%,_#000_100%)] text-white font-kanit w-full xl:max-w-[550px] rounded-3xl p-8 lg:px-14 lg:py-16">
        ...
        <p className="text-title-tiny md:text-title-medium md:font-extralight font-extralight text-[#a1a1a1] xl:tracking-[.5px]">
          {description}
        </p>
      </div>
    </div>
