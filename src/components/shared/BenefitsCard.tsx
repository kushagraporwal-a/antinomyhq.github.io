...
const BenefitsCard = ({title, description, imageUrl, small}: BenefitsCardProps) => {
  ...
  return (
    <div className="h-full flex__column bg-gradient-315-light dark:bg-gradient-315 p-[1px] rounded-[13px] w-full md:w-96 xl:w-[550px]">
      <div className="flex__column gap-4 bg-benefit-light-background dark:bg-[linear-gradient(180deg,_#1E1C21_0%,_#000_100%)] text-white font-kanit w-full xl:max-w-[550px] rounded-xl p-4 sm:p-8 lg:px-14 lg:py-16 h-full">
