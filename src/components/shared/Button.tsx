...
const Button = ({children, onClick, variant}: ButtonProps): JSX.Element => {
  const buttonVariants = {
    ...
    navlink: "font-kanit bg-transparent text-[#30EDE6] font-normal text-title-tiny cursor-pointer hover:text-shadow-glow hover:text-shadow transition-all duration-300",
  }
  return (
    <button
      onClick={onClick}
