...
const BUTTON_VARIANTS = {
  ...
  navlink:
    "bg-transparent text-[#30EDE6] dark:text-[#088C8C] font-normal text-title-tiny cursor-pointer hover:text-shadow-glow hover:text-shadow transition-all duration-300",
} as const
