...
const BUTTON_VARIANTS = {
  ...
  navlink:
    "bg-transparent text-tailCall-darkMode---primary-400 dark:text-tailCall-lightMode---primary-600 font-normal text-title-tiny cursor-pointer hover:text-shadow-glow hover:text-shadow transition-all duration-300",
} as const
