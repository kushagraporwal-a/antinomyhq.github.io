        ...
        <div
          ...
          className={clsx(
            ...
            name === "All" && activeCategory === "All"
              ? "!font-medium text-[22px] text-tailCall-lightMode---primary-600 dark:text-tailCall-darkMode---primary-400 border-b-solid border-b-[1px] border-tailCall-lightMode---primary-600 dark:border-tailCall-darkMode---primary-400"
              : activeCategory === name
