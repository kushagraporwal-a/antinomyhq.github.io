---
title: "Windows: Troubleshooting Issues"
sidebar_position: 4
description: "Resolve common Windows runtime errors, like a missing vcruntime140.dll or other issues, by installing the Microsoft Visual C++ Redistributable."
...
<div className="rounded-md border border-blue-300 bg-blue-50 px-4 py-2 mt-3 text-blue-900 text-sm flex items-start gap-2">
  ...
  <span>
    <strong>Tip:</strong> A 64-bit Windows installation can run both 64-bit and 32-bit applications. To ensure maximum
    compatibility, it is recommended to install both the `x64` and `x86` redistributables on a 64-bit system.
  </span>
</div>
...
<div className="rounded-md border border-amber-300 bg-amber-50 px-4 py-2 mt-3 text-amber-900 text-sm flex items-start gap-2">
  ...
  <span>
    ...
    website. Avoid third-party download sites, which may bundle malware.
  </span>
</div>
