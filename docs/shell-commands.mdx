...
<Card variant="tip">
    <p><strong>Purpose of Shell Commands</strong></p>
    <span>The `!` shortcut is designed for quick execution of individual commands without context switching, not as a replacement for your preferred shell environment. For complex shell workflows, interactive sessions, or shell-specific features, continue using your native ZSH, PowerShell, or bash terminal alongside Forge.</span>
</Card>
