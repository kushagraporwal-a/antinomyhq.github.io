...
Enable help mode for tool questions.

The `/help` command switches to help mode, providing assistance and guidance on using Forge tools and features.

**When to use:** Use this when you need help understanding how to use Forge or its various features.
