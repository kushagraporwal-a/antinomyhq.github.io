...
After installing Forge, you can also configure other AI providers. Follow the [Provider Configuration](../quick-setup) guide to set up alternative providers like OpenAI, Anthropic, or OpenRouter.
