...
<Card variant="tip">
  <p><strong>Looking for best practices and examples?</strong></p>
  <span>For comprehensive examples, team management strategies, and real-world use cases, check out our <CustomLink href="/docs/custom-rules-guide">Custom Rules Guide</CustomLink>.</span>
</Card>
